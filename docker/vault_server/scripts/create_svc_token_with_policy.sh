...
save_key_value_to_file "$SSH_MANAGER_ROLE_ID_KEY" "$ROLE_ID" "${VAULT_SERVER_ROLE_AUTH_DIR}" "role_id"
...
# TODO: store it somewhere secure instead of the file in the container.
# May be in the CI's credentials manger, AWS KMS etc.
save_key_value_to_file "$SSH_MANAGER_SECRET_ID_KEY" "$SECRET_ID" "${VAULT_SERVER_ROLE_AUTH_DIR}" "secret_id"
...
# TODO: store it somewhere secure instead of the file in the container.
# May be in the CI's credentials manger, AWS KMS etc.
save_key_value_to_file "$SSH_MANAGER_TOKEN_KEY" "$SSH_MANAGER_TOKEN" "${VAULT_SERVER_ROLE_AUTH_DIR}" "vault_token"
